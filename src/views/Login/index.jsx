        ...
        token ? <Navigate to="/"></Navigate> :
            <div className='login'>
                <div className='login_'>
                    ...
                    <br></br><br></br>
                    <Button size="large" type="primary" block onClick={() => userLogin(username, password, navite, props.loginSuccess)}> Login </Button>
                </div>
            </div>
    )
}

const userLogin = (username, password, navite, loginSuccess) => {
